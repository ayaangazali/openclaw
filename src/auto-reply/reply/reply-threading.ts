...
function resolveConfiguredReplyToMode(
  ...
  // Signal's own account resolver uses. Checking the root chat-type map first let
  // a channel policy override the account default this fallback exists to honor.
