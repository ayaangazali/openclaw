...
export const de: TranslationMap = {
  ...
  sessionsPage: {
    hubTablistLabel: "Sitzungsabschnitte",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für Ihr Handy, Ihre Uhr, Ihren Desktop und Ihren Browser – plus Plugins, um die Fähigkeiten Ihres Agenten zu erweitern.",
    sectionMobile: "Auf Ihrem Handy",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Ihr Android-Telefon als vollwertiger OpenClaw-Knoten – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Übersichtliche Chats und schnelle Antworten von Ihrem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      windows: {
        title: "Windows",
        desc: "Die Windows-Begleit-App verbindet Ihren PC als OpenClaw-Knoten.",
      },
      linux: {
        title: "Linux",
