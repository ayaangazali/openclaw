...
export const fr: TranslationMap = {
  ...
  appsPage: {
    ...
    heroTagline:
      "Applications compagnon pour votre téléphone, votre montre, votre bureau et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    ...
    cards: {
      ...
      plugins: {
        ...
        desc: "Étendez OpenClaw avec des canaux, des outils et des compétences de la communauté.",
      },
    },
  },
  profilePage: {
