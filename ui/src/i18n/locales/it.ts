...
export const it: TranslationMap = {
  ...
  subtitles: {
    ...
    advanced: "Ogni sezione di configurazione rimanente, oltre all'editor del file raw.",
  ...
  appsPage: {
    ...
    heroTagline:
      "App companion per il tuo telefono, orologio, desktop e browser — oltre a plugin per estendere ciò che il tuo agente può fare.",
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Ragionamento",
      speed: "Velocità",
      sessionOverride: "Override della sessione",
