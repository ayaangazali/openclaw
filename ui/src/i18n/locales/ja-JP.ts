...
export const ja_JP: TranslationMap = {
  ...
  subtitles: {
    ...
    apps: "スマホ、ウォッチ、デスクトップ、ブラウザ向けのコンパニオンアプリ。",
  ...
  appsPage: {
    ...
    heroTagline:
      "スマートフォン、時計、デスクトップ、ブラウザ向けのコンパニオンアプリと、エージェントの能力を拡張するプラグイン。",
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "Windowsコンパニオンは、あなたのPCをOpenClawノードとして接続します。",
      },
      linux: {
        title: "Linux",
  ...
  chat: {
    ...
    questions: {
      ...
      timeRemaining: "残り時間",
      ownAnswer: "あなた自身の回答…",
      ownAnswerFor: "{header}へのあなた自身の回答",
      submitting: "送信中…",
