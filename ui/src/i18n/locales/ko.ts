...
export const ko: TranslationMap = {
  ...
  subtitles: {
    ...
    notifications: "게이트웨이에서 보내는 브라우저 푸시 알림입니다.",
  ...
  custodian: {
    ...
    sensitiveReply: "민감한 답변이 전송됨",
    send: "보내기",
    thinking: "OpenClaw가 생각 중입니다",
    requestFailed: "OpenClaw가 답변할 수 없습니다. 다시 시도하세요.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저용 동반 앱 — 그리고 에이전트의 기능을 확장하는 플러그인.",
    sectionMobile: "휴대폰에서",
    sectionWatch: "손목에서",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Android 폰을 완전한 OpenClaw 노드로 — 채팅, 카메라, Canvas까지.",
      },
      appleWatch: {
        title: "Apple Watch",
