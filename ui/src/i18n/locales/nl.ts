...
export const nl: TranslationMap = {
  ...
  appsPage: {
    heroTitle: "Neem OpenClaw overal mee",
    heroTagline:
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Je Android-telefoon als volledige OpenClaw-node — chat, camera en Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      plugins: {
        ...
        desc: "Breid OpenClaw uit met channels, tools en skills uit de community.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    questions: {
      ...
      submitFailed: "Kan niet indienen: {error}",
      answered: "Beantwoord",
