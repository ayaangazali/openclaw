...
export const pl: TranslationMap = {
  ...
  appsPage: {
    ...
    cards: {
      ...
      windows: {
        title: "Windows",
        desc: "Aplikacja towarzysząca Windows łączy Twój komputer jako węzeł OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Pozwól OpenClaw sterować Twoim Chrome — karty, strony i formularze.",
      },
      plugins: {
        title: "Wtyczki i ClawHub",
        desc: "Rozszerzaj OpenClaw o kanały, narzędzia i umiejętności od społeczności.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Rozumowanie",
      speed: "Prędkość",
      sessionOverride: "Nadpisanie sesji",
      usingDefault: "Używanie wartości domyślnej z Ustawień",
