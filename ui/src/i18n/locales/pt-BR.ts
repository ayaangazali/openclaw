...
export const pt_BR: TranslationMap = {
  ...
  sessionsView: {
    ...
    lastActive: "Ativo por último {time}",
    surface: "Superfície",
    subject: "Assunto",
    room: "Sala",
    space: "Espaço",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Seu celular Android como um nó OpenClaw completo — chat, câmera e Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O companheiro Android estende o OpenClaw para o seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus do seu Gateway — notificações, aprovações e conversa rápida.",
      },
      windows: {
        title: "Windows",
        desc: "O companheiro para Windows conecta seu PC como um nó OpenClaw.",
      },
      linux: {
        title: "Linux",
