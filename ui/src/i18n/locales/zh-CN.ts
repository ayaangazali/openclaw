...
export const zh_CN: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "云工作器需要 OpenClaw 运行时；当前选择了 {runtime}。",
  ...
  appsPage: {
    ...
    heroTagline: "适用于您的手机、手表、桌面和浏览器的配套应用——以及扩展您的智能体功能的插件。",
    sectionMobile: "在您的手机上",
    sectionWatch: "在您的手腕上",
    sectionDesktop: "在您的桌面上",
    sectionBrowser: "在浏览器中",
    sectionCommunity: "社区",
    badgeBundledIos: "iOS 应用内含",
    badgeBundledAndroid: "Android 应用内含",
